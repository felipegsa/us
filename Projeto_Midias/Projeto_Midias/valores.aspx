<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="valores.aspx.cs" Inherits="Projeto_Midias.ADM.valores" %>
...
<body>
    ...
    <div>
        ...
        <div id="menu">
                ...
                <!-- INICIO DO CONTEUDO -->
                <div id="conteudo">
        	        <h1>  A Universidade do Software - Valores</h1>
                    <div id="menu-lateral">
           	          <ul>
                  ...
                  <div id="meio-portal"> 
                  <ul>
			        <li> Comprometimento - (O nosso dever é ter o comprometimento, responsabilidades, buscar a cada dia uma forma melhor de fazer as coisas, passar confiança)</li>
			        <li> Qualidade - (Acreditamos que disponibilizando uma boa qualidade, formamos uma boa imagem demonstrando nossa responsabilidade, foco e seriedade.)</li>
			        <li> Aprendizagem - (Acreditamos que aprendizagem é o processo pelo qual as competências, habilidades, conhecimentos, comportamento e valores são adquiridos ou modificados, como resultado de estudo, experiência, formação, raciocínio e observação.)</li>
			        <li> Ética - (Valorizamos uma postura íntegra, justa, honesta, valorizando o respeito mútuo e pelo próximo)</li>
