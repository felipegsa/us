<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="colaboradores.aspx.cs" Inherits="Projeto_Midias.colaboradores" %>
    ...
    <div>
        ...
        <div id="corpo">
            ...
            <div id="menu">
                    ...
                    <div id="conteudo">
       	              <h1>  Colaboradores </h1>
       	              <div id="meio-colaboradores"> 
            				
                            <div id="bloco">
                                <div id="foto"><img src="images/img-perfil-colaborador.jpg" title="COLABORADOR" alt="COLABORADOR" /></div>
                                <div id="info-colaborador">
                                <span>MARCELO DO CARMO</span>
                                <p> <strong style="color:#142541;">Função Realizada: </strong>Lorem Ipsum dolor In aliquam augue, diam! Placerat porta penatibus, lundium, sit, augue elementum, lundium sit proin elementum! Quis. In diam porta in mus porttitor, a magna urna turpis.</p>
                                <p> <strong style="color:#142541;"> Equipe: </strong>Lorem Ipsum dolor</p>
                                <div id="pdf"> <a href="#">Download do Curriculo</a></div>
                                </div>
                            </div>
