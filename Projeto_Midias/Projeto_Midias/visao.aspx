<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="visao.aspx.cs" Inherits="Projeto_Midias.ADM.visao" %>
...
<body>
    ...
    <div>
        ...
        <div id="menu">
                ...
                <!-- INICIO DO CONTEUDO -->
                <div id="conteudo">
        	        <h1>  A Universidade do Software - VisÃo</h1>
                    <div id="menu-lateral">
           	          <ul>
                  ...
                  <div id="meio-portal"> 
          	        <p> Tornar-se uma empresa capaz de oferecer ferramentas para a construção do conhecimento condizente com o avanço tecnológico, com referência de qualidade e competência na Educação.</p>
                  </div> 
