<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="portal.aspx.cs" Inherits="Projeto_Midias.portal" %>
...
<body>
    ...
    <div>
        ...
        <div id="menu">
                ...
                <!-- INICIO DO CONTEUDO -->
                <div id="conteudo">
        	        <h1>  A Universidade do Software</h1>
                    <div id="menu-lateral">
           	          <ul>
                  ...
                  <div id="meio-portal">
                    <p> <strong>O que é anossa empresa?</strong></p>
			        <p> A Universidade do Software é um site voltado para a educação, iniciou suas atividades em Dezembro de 2012. </p>
        			
                    <br />

			        <p> <strong>Quais os objetivos?</strong></p>
 			        <p> O nosso objetivo é oferecer informações de qualidade de forma que facilite na aprendizagem. Utilizando os recursos digitais disponíveis na internet e formas diferentes de abordagem dos assuntos com: vídeo aulas, jogos e testes.</p>
                    
                    <br />
                    
                    <p> <strong>Equipe</strong></p>
			        <p> A nossa equipe é formado por alunos do 4º ano do curso de Sistemas de Informação da Faculdade de Filosofia e Letras de Santo André, que buscam o crescimento mútuo e buscam alcançar um objetivo em comum. Trabalho esse que temos uma orientação assistida por nosso Mestre e Professor Rubens Sales que acreditou no nosso potencial e nos deu a oportunidade de desenvolver esse projeto.</p>
