<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="atendimento.aspx.cs" Inherits="Projeto_Midias.atendimento" %>
    ...
    <div>
        ...
        <div id="menu">
                ...
                <div id="conteudo">
       	          <h1> atendimento </h1>
       	          <div id="meio-portal"> 
                  <p class="fomr-p"> Preencha o formulário abaixo para entrar em contato conosco, ou mande um e-mail diretamente para atendimento@universidadedosoftware.com.br</p><br /><br />
               
                <form action="" method="post" name="contato_form" id="contato_form">
              
                <fieldset>
      		        <p><label for="nome">*Nome:
       	          <input name="nome" type="text" id="nome" size="35" maxlength="50" /></label></p>
              
      		        <p><label for="telefone" style="clear:left;">*Telefone:
        	        <input name="telefone" type="text" id="telefone" size="35" maxlength="50" /></label></p>
              
     		        <p><label for="email">*E-mail:
        	        <input name="email" type="text" id="email" size="35" maxlength="50" /></label></p>
              
      		        <p><label for="mensagem">*Mensagem: 
       	          <textarea name="mensagem" id="mensagem" cols="35" rows="10"></textarea></label></p>
              
      		        <p><label for="enviar">
       	          <input class="enviar" name="enviar" type="submit" title="Enviar Mensagem" value="Enviar" /></label></p>
                </fieldset>
      	        <p class="obrigatorio"> * Campo Obrigatorio </p>
                <img src="images/atendimento.png" alt="Atendimento" width="330" height="362" title="Atendimento" />
               </form>
